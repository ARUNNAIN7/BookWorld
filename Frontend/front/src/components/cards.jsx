...
function Cards({item}) {
  ...
  return (
   <>
   <div className='mt-4 my-2 mx-4 p-5'>
    <div className="card  w-90 bg-base-100 shadow-xl hover:scale-105 duration-1000 dark:bg-slate-900 dark:text-white dark:border">
  <figure>
    <img
      src={item.image}
      alt="Shoes" />
